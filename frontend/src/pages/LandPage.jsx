      ...
      <section className='container mx-auto mb-12'>
        <div className='grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6'>
          ...
          <div className='md:col-span-8 bg-white rounded-3xl p-8 shadow-md'>
            ...
            <p className='text-gray-600 mb-6'>
              My goal is to share these precious moments of Toqui with you and build a supportive community where we can
              exchange knowledge, share experiences, and help each other provide the best care for our furry friends.
            </p>
            <div className='flex gap-4 items-center'>
              {/* LinkedIn */}
              <a href='https://www.linkedin.com/in/ayen-t-3a2950312/' target="_blank" className='text-pink-500 hover:text-pink-600'>
