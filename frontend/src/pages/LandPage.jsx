  ...
  return (
    <div className='min-h-screen bg-transparent p-4 md:p-8 font-satoshi'>
      ...
      <section className='container mx-auto mb-12'>
        <h2 className='text-3xl font-bold text-center mb-8 text-gray-800'>Discover What We Offer</h2>

        <div className='grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6'>
          {/* Blog Feature */}
          <div className='md:col-span-4 bg-pink-50 rounded-3xl p-6 shadow-md hover:shadow-lg transition-shadow'>
          ...
          <div className='md:col-span-4 md:row-span-2 bg-gradient-to-b from-purple-50 to-purple-100 rounded-3xl p-6 shadow-md hover:shadow-lg transition-shadow flex flex-col justify-between'>
            <div>
          ...
          <div className='md:col-span-4 bg-blue-50 rounded-3xl p-6 shadow-md hover:shadow-lg transition-shadow'>
          ...
          {/* Quick Join Card */}
          <div className='md:col-span-12 bg-gradient-to-r from-toquiPrimary to-toquiDark rounded-3xl p-6 shadow-md text-white flex flex-col md:flex-row items-center justify-between'>
            <div>
              <h3 className='text-xl font-semibold mb-2'>Join Our Rabbit-Loving Community</h3>
              <p className='opacity-90 mb-4 md:mb-0'>Connect with fellow rabbit owners and share experiences!</p>
            </div>
            <button className='px-6 py-3 bg-white text-pink-500 font-medium rounded-full shadow-md hover:shadow-lg transition-shadow'>
              Join Now
            </button>
          </div>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6'>
          ...
          <div className='md:col-span-8 bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-lg transition-shadow'>
            <div className='grid grid-cols-1 md:grid-cols-2'>
              ...
              <div className='p-6 flex flex-col'>
                ...
                <h3 className='mt-3 text-xl font-semibold text-gray-800'>Toqui's Favorite Veggie Mix</h3>
          ...
          <div className='md:col-span-4 bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-lg transition-shadow'>
            ...
            <div className='p-6'>
              ...
              <h3 className='mt-3 text-xl font-semibold text-gray-800'>Finding Rabbit-Savvy Vets</h3>
          ...
          <div className='md:col-span-5 bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-lg transition-shadow'>
            ...
            <div className='p-6'>
              ...
              <h3 className='mt-3 text-xl font-semibold text-gray-800'>Creating a Bunny-Proof Home</h3>
              <p className='mt-2 text-gray-600 line-clamp-3'>
      ...
      <section className='container mx-auto mb-12'>
        <div className='grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6'>
          ...
          <div className='md:col-span-7 bg-white rounded-3xl p-8 shadow-md'>
            <h2 className='text-2xl md:text-3xl leading-tight font-bold text-gray-800 mb-4'>Stay Updated with Toqui</h2>
            <p className='text-gray-600 mb-6'>
          ...
          <div className='md:col-span-5 grid grid-cols-2 gap-4'>
            <div className='bg-pink-50 rounded-3xl p-6 shadow-md flex flex-col items-center justify-center'>
              ...
              <div className='text-gray-600 text-center'>Active Community Members</div>
            </div>
            <div className='bg-purple-50 rounded-3xl p-6 shadow-md flex flex-col items-center justify-center'>
              ...
              <div className='text-gray-600 text-center'>Vet Recommendations</div>
            </div>
            <div className='bg-blue-50 rounded-3xl p-6 shadow-md flex flex-col items-center justify-center col-span-2'>
              ...
              <div className='text-gray-600 text-center'>Rabbit Care Guides</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className='grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6'>
          ...
          <div className='md:col-span-8 bg-white rounded-3xl p-8 shadow-md'>
            ...
            <p className='text-gray-600 mb-4'>
              Hi there! I'm a passionate rabbit owner and web developer who created this platform to share my journey
              with Toqui and connect with other rabbit enthusiasts.
            </p>
            <p className='text-gray-600 mb-6'>
              My goal is to build a supportive community where we can exchange knowledge, share experiences, and help
              each other provide the best care for our furry friends.
            </p>
