          ...
          <div className='md:col-span-4'>
            ...
            <div className='bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6 mb-8'>
              ...
              <p className='text-gray-700 dark:text-gray-300 text-tiny mb-3'>
                Rabbits have nearly 360° panoramic vision but they can't see directly in front of their noses—there's a
                small blind spot there!
              </p>
            ...
            <div className='border rounded-lg p-6 mb-8'>
              ...
              <p className='text-gray-700 dark:text-gray-300 text-tiny mb-4'>
                A weekly, ad-free newsletter that helps bunny parents stay in the know on topics that matter critically
                about rabbit care.
              </p>
              <form className='mb-2'>
                <input
