        ...
        <form action='' id='formElement' className='w-[80%] max-w-[400px]'>
          ...
          <div className='flex items-center justify-center space-x-4 cursor-pointer py-3'>
            ...
            <span
              ...
              className='p-4 bg-white border border-gray-300 rounded-full hover:drop-shadow-sm hover:bg-black/5'>
          ...
          <div className='relative w-full flex items-center gap-2 my-2 opacity-25 uppercase text-black font-bold'>
