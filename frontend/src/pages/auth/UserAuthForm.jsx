    ...
    <AnimatedContent>
      <section className='h-cover flex items-center justify-center font-satoshi mt-8'>
        <form action='' className='w-[80%] max-w-[400px]'>
          <h1 className='text-3xl md:text-4xl capitalize text-center font-bold'>
          ...
          <Link to='/user/auth' className='flex justify-center items-center'>
            <button className='mt-6 rounded-md bg-pink-800 px-6 py-2.5 text-white transition-colors text-tinyhover:bg-pink-800/80'>
