      ...
      <CardBody className='bg-gray-100 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  '>
        ...
        <CardItem translateZ='100' className='w-full mt-4'>
          <img
            ...
            className='max-h-64 w-full object-cover rounded-xl group-hover/card:shadow-xl'
            alt='thumbnail'
          />
        </CardItem>
        <div className='flex justify-between items-center mt-20'>
          ...
          <Link to='/register' className='logo flex items-center space-x-2 z-50'>
            <button className='rounded-md bg-gray-800 px-6 py-2.5 text-base text-white transition-colors hover:bg-gray-600 focus:outline-none'>
              Sign In
            </button>
          </Link>
        </div>
