...
export const Card = ({ card, index, layout = false }) => {
  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <div className='fixed inset-0 h-screen z-50 overflow-auto font-satoshi'>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            <motion.div
              ...
              className='max-w-5xl mx-auto bg-transparent dark:bg-neutral-900 h-fit z-[60] p-4 md:p-10 rounded-3xl font-satoshi relative'>
              <button
                className='sticky top-4 h-8 w-8 right-0 ml-auto dark:bg-white rounded-full flex items-center justify-center'
                onClick={handleClose}>
